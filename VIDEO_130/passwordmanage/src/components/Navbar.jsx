...
const Navbar = () => {
  ...
  const SettingsIcon = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.23.46a2 2 0 0 0 .73 2.73l.15.08a2 2 0 0 1 1 1.74v.52a2 2 0 0 1-1 1.74l-.15.08a2 2 0 0 0-.73 2.73l.23.46a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2-2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.23-.46a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.52a2 2 0 0 1 1-1.74l.15-.08a2 2 0 0 0 .73-2.73l-.23-.46a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 2v-.18a2 2 0 0 0-2-2z" />
        ...
        {isMenuOpen && (
          <div className='md:hidden border-t border-slate-700/50'>
            <div className='px-2 pt-2 pb-3 space-y-1 bg-slate-800/50 backdrop-blur-sm'>
              ...
              >
                <span className='text-lg group-hover:text-green-400 transition-colors'>🏠</span>
                <span className='font-medium'>Home</span>
              </a>
              <a
                href="#"
              ...
              <a
                ...
                className='flex items-center space-x-3 px-3 py-3 rounded-lg text-gray-300 hover:text-white hover:bg-slate-700/50 transition-all duration-300 group'
              >
                <span className='text-lg group-hover:text-green-400 transition-colors'>⚙️</span>
                <span className='font-medium'>About</span>
              </a>
            </div>
          </div>
